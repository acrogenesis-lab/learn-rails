...
ENV DATABASE_URL postgres://qwgrvpovwzsuai:QVVapasE1AJY-EDjErD8e3bLtn@ec2-54-204-0-120.compute-1.amazonaws.com:5432/dahh1osatcsurn
...
ONBUILD RUN bundle install --without development test # TODO: desirable if --path parameter were passed
